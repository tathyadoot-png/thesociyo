...
export default function EcosystemsSection() {
  ...
  return (
    ...
    >
      ...
      {/* RED ORB (kept as is, but you can reduce if needed) */}
      <motion.div
        style={{ y: orbY }}
        className="
          absolute
      ...
      <div
        className="
          relative z-20
          flex flex-col
          gap-14 md:gap-[12vh] xl:gap-[14vh]
          pb-14 md:pb-[10vh]
        "
      >
        {ecosystemsData.map((item, index) => (
          ...
          >
            ...
            >
              <div className="text-[30vw] md:text-[18vw] font-display uppercase leading-none tracking-[-0.08em] text-white/[0.02]">
                0{index + 1}
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className={`
                relative lg:z-20 overflow-hidden rounded-[1.1rem] md:rounded-[1.5rem]
                shadow-2xl w-[82%] sm:w-[68%] md:w-[42vw] lg:w-[26vw] xl:w-[22vw]
            ...
            {/* TEXT BLOCK */}
            <div className={`relative z-20 flex items-center mt-4 lg:-mt-[14rem] px-0 md:px-2 lg:px-4 ${index % 2 === 0 ? "justify-end" : "justify-start"}`}>
              <div className="max-w-[90%] xl:max-w-2xl">
                ...
                <motion.h2
                  initial={{ y: "120%", skewY: 6 }}
                  whileInView={{ y: 0, skewY: 0 }}
                  transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
                  className="text-[1.5rem] sm:text-[2rem] md:text-[3rem] xl:text-[4rem] leading-[0.84] tracking-[-0.065em] font-display uppercase text-white"
                >
                  {item.title}
                </motion.h2>
                ...
                <motion.p
                  ...
                  className="mt-7 text-sm sm:text-base md:text-lg leading-[1.8] text-white/70"
                >
                  {item.description}
                </motion.p>
              </div>
