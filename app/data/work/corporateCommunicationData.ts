...
export const corporateCommunicationData = {
  ...
  short: "Corporate Communication Systems",
  ...
  cover: {
    ...
    subtitle: "Corporate Communications Portfolio",

    description:
      "A creative communication and consultancy agency specialized in brand building, reputation management and strategic communication across every platform.",
  ...
  perspective: {
    ...
    description: [
      "The way a brand speaks, presents itself, responds, markets and connects with people directly influences how it is trusted, remembered and chosen.",

      "Every interaction shapes reputation.",

      "Every message influences credibility.",
  ...
  lookingAhead: {
    ...
    description: [
      "As markets evolve, communication will become even more central to business growth.",
  ...
  closingStatement: {
    ...
    description: [
      "We discover what makes brands valuable.",

      "We decode how audiences connect.",

      "We deliver the communication that moves markets.",

      "From strategy to execution, every communication layer aligned under one vision.",

      "That’s the Sociyo approach.",
    ],
  },
  ...
  contact: {
    ...
    phone: "+91 9555-106208",

    address:
      "FI-026, 5th Floor, Bansal One, Bhopal, Madhya Pradesh - 462016",
  },
};